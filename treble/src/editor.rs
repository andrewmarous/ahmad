...
pub struct AhmadWindow {
    ...
    iced_state: ui::UIState,
    iced_cache: iced_runtime::user_interface::Cache,
...
impl AhmadWindow {
    ...
    async fn create(
        ...
        let engine = iced_wgpu::Engine::new(
            &adapter, &device, &queue, swapchain_format.clone(), None
        );
        ...
        Self {
            ...
            params,
            iced_renderer,
            iced_state: ui::UIState::default(),
            iced_cache: iced_runtime::user_interface::Cache::new(),
        }
    }
}
